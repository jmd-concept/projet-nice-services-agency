          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                ...
                développement dédié aux talents du secteur visuel. Il rassemble
                photographes, vidéastes, graphistes, designers, créateurs de
                contenu et autres professionnels de l’image autour d’une vision
                commune : promouvoir l’excellence créative et l’innovation.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed text-sm lg:text-base">
                  Devenir une référence incontournable dans l’industrie créative
                  en Afrique en offrant des solutions visuelles qui inspirent,
                  captivent et génèrent de la valeur.
                </p>
              </motion.div>
